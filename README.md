...
4. Install and activate the [FAIR Connect plugin](https://github.com/fairpm/fair-plugin) required for testing. Note: it can't be added via Composer until https://github.com/fairpm/fair-plugin/issues/505 is fixed.
